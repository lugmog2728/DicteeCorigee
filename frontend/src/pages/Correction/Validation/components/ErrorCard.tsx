      ...
      <div className="flex items-center gap-1 shrink-0">
        <div className="relative">
          <select
            ...
            className="h-[36px] bg-[#f3f3f5] rounded-[8px] pl-3 pr-7 text-[12px] font-medium text-[#0a0a0a] appearance-none outline-none cursor-pointer"
          >
            {CATEGORIES.map(c => (
        ...
        <button
          type="button"
          onClick={onValidate}
          className="size-8 rounded-[8px] flex items-center justify-center hover:bg-[#f0fdf4] text-[#16a34a] transition-colors"
        >
          <Check size={16} />
        </button>
        <button
          type="button"
          onClick={onReject}
          className="size-8 rounded-[8px] flex items-center justify-center hover:bg-[#fff1f2] text-[#e11d48] transition-colors"
        >
          <X size={16} />
        </button>
      </div>
